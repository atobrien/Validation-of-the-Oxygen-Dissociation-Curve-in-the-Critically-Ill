...
```{r}
# Write CSV in R from Data
# write.csv(data1, file = "ODC_eicu_for_apache.csv")
```
...
Filter APACHE Score by 72 or above

```{r}
df<-df %>% filter(apache >= 72)
```

Side note
There were 9,776 unique rows of data for apache scores greater than or equal
to 72.
